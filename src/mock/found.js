  ...
  const result = {
    ...
    data: {
      feed_info_list: [{
        ...
        feed_detail: {
          image_list: [{
            image: 'http://saidad.oss-cn-guangzhou.aliyuncs.com/image/394a8541cb7922cab4c99ce787b1361d.jpeg',
            width: 1646,
            height: 1080
          }],
          description: '我怕生日别人送的花我不喜欢，所以自己买了',
          title: null,
          content_tag_list: null
        },
        feed_base_info: {
 ...
 * @param {*} response
 */
const getDetailList = (request, response) => {
  const result = {
    errorCode: 0,
    errorMessage: 'success',
    data: {
...
const FoundMockAPI = (app) => {
  app.post('/mock/feed/FlowerFeed/getFoundList', getFoundList)
  app.post('/mock/feed/FlowerFeed/getFeedDetail', getDetailList)
  // 这里是'http请求路由 不要这个点 明白么   你重启一下项目 再试试 文件保存一下
}
//  导出接口
module.exports = FoundMockAPI
